...
through the real farm to prove the collector reads the real scene end-to-end. Copy them together
with the neighbouring maps/HDRI files.
...
install the samples that ship with 3ds Max and mirror the layout above.
